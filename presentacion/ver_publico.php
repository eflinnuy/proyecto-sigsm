...
<html lang="es">
    <head>
        <meta charset="UTF-8"> <meta name="viewport" content="width=device-width,initial-scale=1"> <link rel="stylesheet" href="css/estilo.css">
        <title>
            <?= limpiar($d['titulo']) ?>
        </title>
    </head>
    <body>
        <main class="movil">
            ...
            <a class="boton" href="../documentos/<?= rawurlencode($d['archivo']) ?>" target="_blank"> Ver documento PDF</a> <a class="boton secundario" href="../portal.php"> Volver al portal</a>
        </main>
    </body>
</html>
